...
extern const CLSID CLSID_IVirtualNotificationService;

extern const CLSID CLSID_IVirtualDesktopManager;
...
const __declspec(selectany) IID& IID_IWin32ApplicationView = __uuidof(IWin32ApplicationView);
